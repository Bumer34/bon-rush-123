...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-d1ac9c21');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-d1ac9c21');}
...
var brandEl=document.querySelector('.rl-brand-d1ac9c21');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
